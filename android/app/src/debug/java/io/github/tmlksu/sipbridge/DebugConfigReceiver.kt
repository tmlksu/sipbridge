 ...
 * 例:
 * ```
 * adb shell am broadcast -a io.github.tmlksu.sipbridge.DEBUG_SET_CONFIG \
...
class DebugConfigReceiver : BroadcastReceiver() {
    ...
    companion object {
         ...
         * 例: `adb shell am broadcast -a io.github.tmlksu.sipbridge.DEBUG_CALL_ACTION --es action answer`
         */
